...
class SmartMeterDiscreteEpisode:
    """
    ...
    def __init__(self, selected_aggregate_load_df: pd.DataFrame):
        ...
        self.convert_load_to_logit()  # Convert the aggregate load values to logits for discrete action space
    ...
    def convert_load_to_logit(self, step_size=50):
        """
        Convert the aggregate load values to logits for discrete action space.
        Args:
            step_size (int): The step size for discretization (default: 50W).
        """
